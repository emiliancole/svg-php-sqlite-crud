...
if( isset($_POST['submit_data']) ){
	...
	$query = "UPDATE imagetr SET x='$x',y='$y', width='$width',height='$height',     
    href='$href',transform='$transform',view='$view' WHERE rowid=$id";
...
$query = "SELECT * FROM imagetr WHERE rowid=$id";
...
?>
	<div style="width:700px; margin: 20px auto;">
		...
		<div><?= $message;?></div>UPDATE imagetr
