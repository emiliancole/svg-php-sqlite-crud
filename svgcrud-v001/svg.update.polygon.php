...
if( isset($_POST['submit_data']) ){
	...
	$id = $_POST['id'];
	$d = $_POST['points']; $style = $_POST['style'];
    
	$query = "UPDATE polygon SET points='$points', style='$style' WHERE rowid=$id";
...
<body>
	<div style="width:700px; margin: 20px auto;">
		...
		<table width="100%" cellpadding="5" cellspacing="1" border="1">
			...
			<tr>
				<td>==></td>
				<td><input name="submit_data" type="submit" value="Update Svg polygon Data"></td>
			</tr>
			</form>
		</table>
	</div>
